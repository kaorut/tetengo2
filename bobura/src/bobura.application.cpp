...
namespace bobura
{
    ...
    public:
        ...
        int run()
        {
            ...
            main_window.set_menu_bar(
                build_main_window_menu(command_set_holder.command_set(), m_model, main_window, message_catalog)
            );
    ...
    private:
        ...
        static void append_menu_separator(menu_base_type& popup_menu, std::vector<const command_type*>& commands)
        {
