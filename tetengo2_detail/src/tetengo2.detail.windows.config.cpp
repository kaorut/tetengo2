...
namespace tetengo2::detail::windows {
    ...
    private:
        ...
        private:
            ...
            {
                ::HKEY     handle = nullptr;
                const auto create_key_result = ::RegCreateKeyExW(
                    HKEY_CURRENT_USER,
        ...
        static std::pair<string_type, string_type>
        build_registry_key_and_value_name(const string_type& group_name, const string_type& key)
        {
            std::vector<string_type> key_names{};
            boost::split(key_names, key, [](const string_type::value_type c) {
            ...
            return std::make_pair(
                path_prefix() + group_name + string_type{ TETENGO2_TEXT("\\") } +
                    boost::join(
        ...
        static std::pair<value_kind_type, string_type::size_type>
        query_value_kind(const ::HKEY handle, const string_type& key)
        {
            ::DWORD    type = 0;
            ::DWORD    value_size = 0;
        ...
        static string_type
        get_string(const ::HKEY handle, const string_type& key, const string_type::size_type result_length)
        {
            std::vector<native_string_type::value_type> value(result_length, 0);
            auto       value_size = static_cast<::DWORD>(result_length * sizeof(native_string_type::value_type));
        ...
        static void set_string(const ::HKEY handle, const string_type& key, const string_type& value)
        {
            ...
            ::RegSetValueEx(
                ...
                static_cast<::DWORD>((encoded_value.length() + 1) * sizeof(native_string_type::value_type)));
        }
