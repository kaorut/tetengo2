...
namespace tetengo2::detail::windows::gdiplus {
    ...
    public:
        ...
        std::unique_ptr<picture_details_type> create_picture_impl(const gui::type_list::dimension_type& dimension) const
        {
            ...
            return std::make_unique<gdiplus_picture_details_type>(width.to_pixels(), height.to_pixels());
        }
        ...
        {
            return std::make_unique<gdiplus_picture_details_type>(123, 456);
        }
        ...
        gui::type_list::dimension_type picture_dimension_impl(const picture_details_type& picture) const
        {
            return gui::type_list::dimension_type{
                gui::type_list::dimension_unit_type::from_pixels(
                    static_cast<const gdiplus_picture_details_type&>(picture).dimension.first),
                gui::type_list::dimension_unit_type::from_pixels(
                    static_cast<const gdiplus_picture_details_type&>(picture).dimension.second)
            };
        }
    ...
    private:
        ...
        struct gdiplus_picture_details_type : public picture_details_type
        {
            ...
            gdiplus_picture_details_type(const type_list::size_type width, const type_list::size_type height)
