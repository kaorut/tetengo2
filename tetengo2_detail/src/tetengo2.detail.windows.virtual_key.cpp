...
namespace tetengo2::detail::windows {
    ...
    public:
        ...
        {
            return { static_cast<code_type>(VK_BACK), string_type{ TETENGO2_TEXT("BackSpace") } };
        }

        std::pair<code_type, string_type> tab_impl() const
        {
            return { static_cast<code_type>(VK_TAB), string_type{ TETENGO2_TEXT("Tab") } };
        }

        std::pair<code_type, string_type> enter_impl() const
        {
            return { static_cast<code_type>(VK_RETURN), string_type{ TETENGO2_TEXT("Enter") } };
        }

        std::pair<code_type, string_type> shift_impl() const
        {
            return { static_cast<code_type>(VK_SHIFT), string_type{ TETENGO2_TEXT("Shift") } };
        }

        std::pair<code_type, string_type> control_impl() const
        {
            return { static_cast<code_type>(VK_CONTROL), string_type{ TETENGO2_TEXT("Ctrl") } };
        }

        std::pair<code_type, string_type> meta_impl() const
        {
            return { static_cast<code_type>(VK_MENU), string_type{ TETENGO2_TEXT("Alt") } };
        }

        std::pair<code_type, string_type> escape_impl() const
        {
            return { static_cast<code_type>(VK_ESCAPE), string_type{ TETENGO2_TEXT("Esc") } };
        }

        std::pair<code_type, string_type> space_impl() const
        {
            return { static_cast<code_type>(VK_SPACE), string_type{ TETENGO2_TEXT("Space") } };
        }

        std::pair<code_type, string_type> page_up_impl() const
        {
            return { static_cast<code_type>(VK_PRIOR), string_type{ TETENGO2_TEXT("PageUp") } };
        }

        std::pair<code_type, string_type> page_down_impl() const
        {
            return { static_cast<code_type>(VK_NEXT), string_type{ TETENGO2_TEXT("PageDown") } };
        }

        std::pair<code_type, string_type> end_impl() const
        {
            return { static_cast<code_type>(VK_END), string_type{ TETENGO2_TEXT("End") } };
        }

        std::pair<code_type, string_type> home_impl() const
        {
            return { static_cast<code_type>(VK_HOME), string_type{ TETENGO2_TEXT("Home") } };
        }

        std::pair<code_type, string_type> left_impl() const
        {
            return { static_cast<code_type>(VK_LEFT), string_type{ TETENGO2_TEXT("Left") } };
        }

        std::pair<code_type, string_type> up_impl() const
        {
            return { static_cast<code_type>(VK_UP), string_type{ TETENGO2_TEXT("Up") } };
        }

        std::pair<code_type, string_type> right_impl() const
        {
            return { static_cast<code_type>(VK_RIGHT), string_type{ TETENGO2_TEXT("Right") } };
        }

        std::pair<code_type, string_type> down_impl() const
        {
            return { static_cast<code_type>(VK_DOWN), string_type{ TETENGO2_TEXT("Down") } };
        }

        std::pair<code_type, string_type> insert_impl() const
        {
            return { static_cast<code_type>(VK_INSERT), string_type{ TETENGO2_TEXT("Ins") } };
        }

        std::pair<code_type, string_type> del_impl() const
        {
            return { static_cast<code_type>(VK_DELETE), string_type{ TETENGO2_TEXT("Del") } };
        }
        ...
        {
            return { static_cast<code_type>(VK_F1), string_type{ TETENGO2_TEXT("F1") } };
        }

        std::pair<code_type, string_type> f2_impl() const
        {
            return { static_cast<code_type>(VK_F2), string_type{ TETENGO2_TEXT("F2") } };
        }

        std::pair<code_type, string_type> f3_impl() const
        {
            return { static_cast<code_type>(VK_F3), string_type{ TETENGO2_TEXT("F3") } };
        }

        std::pair<code_type, string_type> f4_impl() const
        {
            return { static_cast<code_type>(VK_F4), string_type{ TETENGO2_TEXT("F4") } };
        }

        std::pair<code_type, string_type> f5_impl() const
        {
            return { static_cast<code_type>(VK_F5), string_type{ TETENGO2_TEXT("F5") } };
        }

        std::pair<code_type, string_type> f6_impl() const
        {
            return { static_cast<code_type>(VK_F6), string_type{ TETENGO2_TEXT("F6") } };
        }

        std::pair<code_type, string_type> f7_impl() const
        {
            return { static_cast<code_type>(VK_F7), string_type{ TETENGO2_TEXT("F7") } };
        }

        std::pair<code_type, string_type> f8_impl() const
        {
            return { static_cast<code_type>(VK_F8), string_type{ TETENGO2_TEXT("F8") } };
        }

        std::pair<code_type, string_type> f9_impl() const
        {
            return { static_cast<code_type>(VK_F9), string_type{ TETENGO2_TEXT("F9") } };
        }

        std::pair<code_type, string_type> f10_impl() const
        {
            return { static_cast<code_type>(VK_F10), string_type{ TETENGO2_TEXT("F10") } };
        }

        std::pair<code_type, string_type> f11_impl() const
        {
            return { static_cast<code_type>(VK_F11), string_type{ TETENGO2_TEXT("F11") } };
        }

        std::pair<code_type, string_type> f12_impl() const
        {
            return { static_cast<code_type>(VK_F12), string_type{ TETENGO2_TEXT("F12") } };
        }
