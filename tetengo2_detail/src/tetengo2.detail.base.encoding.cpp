...
namespace tetengo2 { namespace detail { namespace base
{
    ...
    encoding::utf8_string_type encoding::pivot_to_utf8(pivot_type pivot)
    const
    {
        return pivot_to_utf8_impl(std::move(pivot));
    }

    encoding::pivot_type encoding::utf8_to_pivot(utf8_string_type string)
    const
    {
    ...
    encoding::pivot_type encoding::cp932_to_pivot(cp932_string_type string)
    const
    {
