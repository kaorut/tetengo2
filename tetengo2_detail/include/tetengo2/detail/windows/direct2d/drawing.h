        ...
        public:
            ...
            */
                ...
                const typename Dimension::unit_type& max_width)
            {
                ...
                return { gui::to_unit<typename Dimension::unit_type>(to_ddp_x(metrics.width)),
            ...
            */
                ...
                const Color&         color)
            {
                ...
                for (const auto& chunk : chunks)
                {
                    ...
                    {
                        chunk_position =
                            Position{ chunk_left + position_unit_type::from(chunk_height), next_chunk_top };
                    }
                    else if (rotation == 2)
                    {
                    ...
                    next_chunk_top += rotation % 2 == 0 ? position_unit_type::from(chunk_height) :
                                                          position_unit_type::from(chunk_width);
                }
            }
        ...
        private:
                ...
                const DimensionUnit& max_width)
            {
                ...
                const ::FLOAT max_width_in_dip = max_width == DimensionUnit{} ?
                                                     ...
                                                     to_dip_x(gui::to_pixels<::FLOAT>(max_width));
