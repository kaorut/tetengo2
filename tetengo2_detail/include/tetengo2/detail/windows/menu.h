...
namespace tetengo2::detail::windows {
    ...
    namespace detail {
        ...
        struct menu_deleter
        {
            void operator()(const ::HMENU menu_handle) const
            {
        ...
        {
            void operator()(const ::HACCEL accelerator_table_handle) const
            {
    ...
    */
    ...
    public:
        ...
        */
        ...
        struct style_tag
        {
            ...
            virtual void set_style(
                ...
                bool                          enabled,
                typename MenuBase::state_type state) const = 0;
#endif
        };
        ...
        */
        ...
        create_shortcut_key_table(const ForwardIterator first, const ForwardIterator last)
        {
    ...
    private:
        ...
        struct popup_menu_style_tag : public style_tag<MenuBase>
        {
                ...
                typename MenuBase::state_type state) const override
            {
                ...
                menu_info.fState |= state == MenuBase::state_type::checked || state == MenuBase::state_type::selected ?
                                        MFS_CHECKED :
                                        MFS_UNCHECKED;
