    ...
    */
    ...
    public:
        ...
        struct widget_details_type
        {
            ...
            widget_details_type(handle_type handle, const ::WNDPROC window_procedure, const ::HWND first_child_handle)
        ...
        */
        template <typename DropdownBox>
        static stdalt::optional<type_list::size_type> selected_dropdown_box_value_index(const DropdownBox& dropdown_box)
        {
        ...
        */
        template <typename ListBox>
        static stdalt::optional<type_list::size_type> selected_list_box_value_index(const ListBox& list_box)
        {
