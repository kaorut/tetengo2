...
BOOST_AUTO_TEST_SUITE(json_writer)
    ...
    BOOST_AUTO_TEST_CASE(read)
    {
        ...
        //reader_type json_writer;
        //{
        //    const std::unique_ptr<timetable_type> p_timetable =
        //        json_writer.read(json0.begin(), json0.end());

        //    BOOST_CHECK(!p_timetable);
        //}
        //{
        //    const std::unique_ptr<timetable_type> p_timetable =
        //        json_writer.read(json1.begin(), json1.end());

        //    BOOST_CHECK(!p_timetable);
        //}
        //{
        //    const std::unique_ptr<timetable_type> p_timetable =
        //        json_writer.read(json2.begin(), json2.end());
        ...
        //{
        //    const std::unique_ptr<timetable_type> p_timetable =
        //        json_writer.read(json3.begin(), json3.end());
        ...
        //{
        //    const std::unique_ptr<timetable_type> p_timetable =
        //        json_writer.read(json4.begin(), json4.end());
        ...
        //{
        //    const std::unique_ptr<timetable_type> p_timetable =
        //        json_writer.read(json5.begin(), json5.end());

        //    BOOST_CHECK(!p_timetable);
        //}
        //{
        //    const std::unique_ptr<timetable_type> p_timetable =
        //        json_writer.read(json6.begin(), json6.end());
        ...
        //{
        //    const std::unique_ptr<timetable_type> p_timetable =
        //        json_writer.read(json7.begin(), json7.end());

        //    BOOST_CHECK(!p_timetable);
        //}
        //{
        //    const std::unique_ptr<timetable_type> p_timetable =
        //        json_writer.read(json8.begin(), json8.end());
