...
namespace tetengo2 { namespace gui
{
    ...
    */
    ...
    Integer ceil(const Unit& value, typename std::enable_if<!std::is_arithmetic<Unit>::value>::type* = NULL)
    {
    ...
    */
    template <typename Integer, typename Unit>
    Integer floor(const Unit& value, typename std::enable_if<!std::is_arithmetic<Unit>::value>::type* = NULL)
    {
