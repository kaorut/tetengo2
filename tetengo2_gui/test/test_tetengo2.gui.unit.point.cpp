...
namespace
{
    ...
    using unit_type = tetengo2::gui::unit::point<boost::rational<std::ptrdiff_t>, unit_details_type>;

    using another_unit_type = tetengo2::gui::unit::point<boost::rational<std::size_t>, unit_details_type>;
