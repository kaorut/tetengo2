...
namespace
{
    ...
    struct Class4
    {
        ...
        Class4(const int value1, const int value2, const int value3, const int value4)
        :
        m_value1(value1),
        m_value2(value2),
        m_value3(value3),
    ...
    struct Class5
    {
        ...
        Class5(const int value1, const int value2, const int value3, const int value4, const int value5)
        :
        m_value1(value1),
        m_value2(value2),
        m_value3(value3),
