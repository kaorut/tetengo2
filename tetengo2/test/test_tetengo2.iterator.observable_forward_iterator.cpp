    ...
    BOOST_AUTO_TEST_SUITE(iterator)
        BOOST_AUTO_TEST_SUITE(observable_forward_iterator)
            ...
            BOOST_AUTO_TEST_CASE(dereference)
            {
                ...
                tetengo2::iterator::observable_forward_iterator<std::forward_list<int>::iterator> iterator{
                    list.begin()
                };
            ...
            BOOST_AUTO_TEST_CASE(increment)
            {
                ...
                const tetengo2::iterator::observable_forward_iterator<std::forward_list<int>::iterator> last{
                    list.end()
                };
