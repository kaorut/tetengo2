        ...
        BOOST_AUTO_TEST_SUITE(config_list)
            ...
            BOOST_AUTO_TEST_CASE(set)
            {
...

                {
                    ...
                    const auto value = config.get(string_type{ TETENGO2_TEXT("foo") });
                    BOOST_TEST_REQUIRE(tetengo2::stdalt::has_value(value));
                    BOOST_CHECK(tetengo2::stdalt::get<string_type>(*value) == string_type{ TETENGO2_TEXT("piyo") });
                }
                {
                    std::vector<std::unique_ptr<config_base_type>> p_configs{};
                    {
                    ...
                    config.set(
                        string_type{ TETENGO2_TEXT("bazz") }, value_type{ string_type{ TETENGO2_TEXT("piyo") } });
            ...
            BOOST_AUTO_TEST_CASE(clear)
            {
...

                {
                    ...
                    BOOST_TEST(!tetengo2::stdalt::has_value(config.get(string_type{ TETENGO2_TEXT("baz") })));
                }
            }
